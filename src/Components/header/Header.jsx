...
export default function Header(props) {
        ...
        <div className="search hidden sm:block">
            <form className="max-w-lg">
                <div className="flex relative">
                    ...
                    <button onClick={() => showSearch.current.classList.toggle("hidden")} style={{ width: "80px" }} id="dropdown-button" data-dropdown-toggle="dropdown" className="btn-search relative text-nowrap overflow-hidden flex-shrink-0 z-10 inline-flex justify-between items-center py-1 px-4 text-xs font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 hover:bg-gray-200" type="button">{sreachType}
                    ...
                    <div id="dropdown" ref={showSearch} style={{
                        ...
                        <ul className="py-2 text-sm text-gray-700" aria-labelledby="dropdown-button">
                            <li>
                                <button onClick={(e) => { setSearchType(e.target.innerText); showSearch.current.classList.toggle("hidden") }} type="button" className="inline-flex w-full px-4 py-2 hover:bg-gray-100">All</button>
                            </li>
                            <li>
                                <button onClick={(e) => { setSearchType(e.target.innerText); showSearch.current.classList.toggle("hidden") }} type="button" className="inline-flex w-full px-4 py-2 hover:bg-gray-100">Engineering</button>
                            </li>
                            <li>
                                <button onClick={(e) => { setSearchType(e.target.innerText); showSearch.current.classList.toggle("hidden") }} type="button" className="inline-flex w-full px-4 py-2 hover:bg-gray-100">Medical</button>
                            </li>
                            <li>
                                <button onClick={(e) => { setSearchType(e.target.innerText); showSearch.current.classList.toggle("hidden") }} type="button" className="inline-flex w-full px-4 py-2 hover:bg-gray-100">Arts & Science</button>
                            </li>
                            <li>
                                <button onClick={(e) => { setSearchType(e.target.innerText); showSearch.current.classList.toggle("hidden") }} type="button" className="inline-flex w-full px-4 py-2 hover:bg-gray-100">Architecture</button>
                            </li>
                            <li>
                                <button onClick={(e) => { setSearchType(e.target.innerText); showSearch.current.classList.toggle("hidden") }} type="button" className="inline-flex w-full px-4 py-2 hover:bg-gray-100">Law</button>
                            </li>
                        </ul>
                    </div>
    ...
    <div className="myprofile relative">
        <button onClick={() => showProfileBar.current.classList.toggle("hidden")} id="dropdownDefaultButton" data-dropdown-toggle="dropdowndpro" className="text-black text-sm font-normal bg-white focus:outline-none global-radius px-3 py-1 text-center inline-flex items-center" type="button">
        ...
        <div id="dropdowndpro" ref={showProfileBar} style={{
            ...
            <ul className="py-2 text-sm text-gray-700" aria-labelledby="dropdownDefaultButton">
                ...
                <li onClick={() => showProfileBar.current.classList.toggle("hidden")}>
                    <Link to="/account/accountsetting" className="block px-4 py-2 hover:bg-gray-100">Settings</Link>
                </li>
                <li onClick={() => showProfileBar.current.classList.toggle("hidden")}>
                    <Link to="/" className="block px-4 py-2 hover:bg-gray-100">Log Out</Link>
                </li>
            </ul>
        </div>
    </div>
